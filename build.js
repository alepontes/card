...
const data = {
  name: chalk.white('               Ale Pontes'),
  handle: chalk.white('alepontes'),
  work: chalk.white('Full Stack Engineer at Mandala Clothing'),
  twitter: chalk.gray('https://twitter.com/') + chalk.cyan('ale_pontes'),
  npm: chalk.gray('https://npmjs.com/') + chalk.red('~alepontes'),
